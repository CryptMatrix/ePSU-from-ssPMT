 ...
 */
    ...
    void gen_waksman_route(int32_t subLogN, int32_t lvl_p, int32_t perm_idx, // log2 size of the current subnet, starting level in the network, and starting switch index in that level.
